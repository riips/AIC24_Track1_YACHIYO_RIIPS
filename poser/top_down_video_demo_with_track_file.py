...
from load_tracking_result import load_tracking
...
def main():
    ...
    parser.add_argument('track_result', help='Track result file')
    ...
    track_results = load_tracking(args.track_result)
    ...
    for frame_id, cur_frame in enumerate(mmcv.track_iter_progress(video)):
        ...
        save_results[frame_id] = pose_results
        # show the results
    ...
    json.dump(save_results, open(args.out_file, 'w'), cls=NumpyEncoder)
